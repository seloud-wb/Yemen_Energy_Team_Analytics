...
def home():
    ...
    applications = [
        {
            "preview_image": "",  # Path to preview image file
            "name": "YEEAP II Monitoring Dashboard",
            "category": "Project Monitoring",
            "title": "YEEAP II Monitoring Dashboard",
            "description": "Monitor and track the progress of YEEAP II projects and performance metrics across Yemen. Track installations, monitor energy generation, and analyze geographic distribution of energy access initiatives."
        },
        {
            "preview_image": "assets/geospatial_preview.png",  # Path to preview image file
            "name": "RESET Geospatial Data Explorer",
            "category": "GEOSPATIAL ANALYSIS",
            "title": "RESET Geospatial Data Explorer",
            "description": "Explore geospatial data, analyze energy infrastructure, and visualize spatial patterns across Yemen's energy landscape. Access detailed datasets and generate insights for energy planning and development."
        }
    ]
    
    # Generate cards HTML from dictionary
    cards_html = ""
    for app in applications:
        # Handle preview image - convert to base64 if provided
        if app["preview_image"]:
            try:
                with open(app["preview_image"], "rb") as img_file:
                    img_data = base64.b64encode(img_file.read()).decode()
                    img_ext = app["preview_image"].split(".")[-1].lower()
                    mime_type = "image/png" if img_ext == "png" else "image/jpeg" if img_ext in ["jpg", "jpeg"] else "image/png"
                    image_html = f'<img src="data:{mime_type};base64,{img_data}" alt="{app["name"]}" style="width: 100%; height: 100%; object-fit: cover;" />'
        ...
        card_html = f"""
                    ...
                    <div onmouseover="this.style.transform='translateY(-4px)'; this.style.boxShadow='0 4px 20px 0 rgba(0,0,0,0.12)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 2px 12px 0 rgba(0,0,0,0.08)';" style="
                        background: white;
                        border-radius: 1rem;
                        padding: 0;
                    ...
                    ">
                        <!-- Image/Left Area (40%) -->
                        <div style="
                            background: linear-gradient(135deg, #7fbbb4 0%, #5a9a94 100%);
                            width: 40%;
                            display: flex;
                            align-items: center;
                            ...
                            overflow: hidden;
                        ">
                            {image_html if app["preview_image"] else ""}
                        </div>
                        <!-- Content Area (60%) -->
                        <div style="
                            width: 60%;
                        ...
                        ">
                            ...
                            <div style="
                                ...
                                background: rgba(127, 187, 180, 0.15);
                                color: #7fbbb4;
    ...
    # Full page block with About and Applications
    html(
        """
        <div style="
            min-height: 80vh;
            ...
            margin: 0;
        ">
            <!-- Header: Flexbox with Title on Left, Logo on Right -->
            ...
            <div style="margin-bottom: 4rem;">
                ...
                <p style="
                    ...
                    margin: 0;
                ">
                    The Yemen Energy Analytics Portal provides comprehensive tools and insights for energy planning, monitoring, and analysis across Yemen. Our suite of applications supports data-driven decision making for energy access, infrastructure development, and renewable energy initiatives.
                </p>
            </div>
